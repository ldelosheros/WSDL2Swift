Pod::Spec.new do |s|
  ...
  generate WSDL+(ServiceName).swift SOAP client by executing WSDL2Swift with WSDL and XSD xml files.
                   DESC
  s.homepage     = "https://gitlab.cloudint.afip.gob.ar/mobile-apps-utils/WSDL2Swift"
  s.license      = "MIT"
  s.author             = { "BAN Jun" => "banjun@gmail.com" }
  s.ios.deployment_target = "11.0"
  s.osx.deployment_target = "10.11"
  s.source       = { :git => "https://gitlab.cloudint.afip.gob.ar/mobile-apps-utils/WSDL2Swift", :tag => "#{s.version}" }
